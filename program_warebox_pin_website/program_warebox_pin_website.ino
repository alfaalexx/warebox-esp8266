...
#define RELAY_PIN 27 //--> Defines a Relay Pin. GPIO15

//----------------------------------------SSID and Password of your WiFi router.
const char* ssid = "OPPO A92"; //--> Your wifi name or SSID.
...
String host_or_IPv4 = "http://192.168.94.22:8080/";
...
void setup() {
  ...
  // Initialize the LCD and print the welcome message
  lcd.init();
  lcd.backlight();
  lcd.setCursor(0, 0);
  lcd.print("Selamat datang");
  lcd.setCursor(0, 1);
  lcd.print("Locker WareBox");
...
void loop() {
  ...
  Destination = "warebox/apps/online/GetData.php";
  URL_Server = host_or_IPv4 + Destination;
  Serial.println("----------------Connect to Server-----------------");
  Serial.println("Get Relay Status from Server or Database");
